          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 rounded-md hover:bg-gray-800/50 transition-colors duration-200"
            ...
            <div className="text-center">
              <span className="text-sm text-gray-200">New here?</span>{" "}
              <Link
                href="/signup"
