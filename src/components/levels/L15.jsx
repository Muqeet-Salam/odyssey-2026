      ...
      >
        ...
        <div className="flex justify-center mb-4">
          <motion.button
            ...
            disabled={isPlaying}
            className={`px-6 py-3 rounded-lg bg-gray-600 text-white flex items-center gap-2 ${
              isPlaying ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-700'
            }`}
          >
            ...
            >
              <div className="p-6 overflow-y-auto flex-grow">
                ...
                <div className="space-y-1 mb-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                    <span className="font-bold text-gray-700 dark:text-gray-300">/listen</span>
                ...
                <h3 className="text-xl font-bold mt-4 mb-2 text-gray-800 dark:text-[#F9DC34]">Hint:</h3>
