...
const Level15 = ({ onComplete }) => {
  ...
  const handleCommandSubmit = () => {
    ...
    if (themeMatch) {
      ...
      toast({
        ...
        variant: "default",
        className: "fixed bottom-12 left-1/2 transform -translate-x-1/2 z-50 bg-black text-[#F9DC34] border-[#F9DC34] opacity-100 shadow-[0_0_20px_rgba(249,220,52,0.5)]",
      });
    } else if (helpMatch) {
  ...
  return (
    <div className="flex flex-col items-center mt-8 max-w-4xl mx-auto px-4 transition-all">
      <motion.h1
        initial={{ opacity: 0, y: -20 }}
        animate={{
          opacity: 1,
          y: 0,
          x: isPlaying ? [0, -2, 2, -2, 0] : 0
        }}
        transition={{
          duration: isPlaying ? 0.2 : 0.6,
        ...
        <div className="bg-white dark:bg-[#1A1A1A]/40 rounded-2xl p-6 shadow-lg backdrop-blur-sm border border-gray-200 dark:border-gray-700/30">
          <div className="flex justify-center mb-6">
            <motion.div
              ...
              className="relative shadow-2xl rounded-full overflow-hidden w-32 h-32 bg-black"
            >
              <video
                ref={videoRef}
                src="/rickroll.webm"
              ...
              <div className="p-6 overflow-y-auto flex-grow">
                ...
                <div className="space-y-1 mb-6">
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">Initiate the symphony.</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">Analyze track metadata.</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">Verify the legend.</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                    <span className="font-bold text-gray-700 dark:text-gray-300">/reset</span>
                    <p className="mt-1 text-gray-600 dark:text-gray-300">Attempt to restore sanity.</p>
                  </div>
                </div>
