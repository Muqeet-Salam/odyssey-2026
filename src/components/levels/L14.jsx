...
const CommandSnake = ({ levelNumber, onComplete, nextLevelNumber }) => {
  ...
  return (
    <div className="flex flex-col items-center mt-4 sm:mt-8 max-w-4xl mx-auto px-4">
      <motion.h1 
        className="px-4 sm:px-6 py-2 sm:py-3 text-xl sm:text-2xl font-bold text-[#1A1A1A] dark:text-[#111111] bg-gradient-to-r from-[#F9DC34] to-[#F5A623] rounded-full shadow-lg"
      >
        Level 14
      </motion.h1>
      ...
      <div className="mt-2 sm:mt-4 border-4 border-gray-700 dark:border-gray-300 inline-block">
        {renderBoard()}
      </div>
