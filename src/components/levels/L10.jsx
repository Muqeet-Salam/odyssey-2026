  ...
  return (
    <div className="flex flex-col items-center mt-8 max-w-4xl mx-auto px-4">
      ...
      <motion.div
        ...
        className="bg-gradient-to-b from-[#87CEEB] via-[#B0D8F0] to-[#5BA3D9] dark:from-[#1a2744] dark:via-[#243654] dark:to-[#0f1d33] rounded-2xl p-0 shadow-2xl border-2 border-gray-200 dark:border-gray-700/40 w-full max-w-md relative overflow-hidden"
      >
