          ...
          >
            ...
            >
              <div className="p-6 overflow-y-auto flex-grow">
                <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-[#F9DC34]">Help</h2>
                <div className="space-y-4">
                  
                  
                  <div>
                    <h3 className="text-xl font-semibold mb-2 text-gray-700 dark:text-gray-300">Commands:</h3>
                    <div className="space-y-2">
                      <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border-l-4 border-[#F5A623]">
                        <span className="font-bold text-gray-700 dark:text-gray-300">/move [Square]</span>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2 text-gray-700 dark:text-gray-300">Hint:</h3>
